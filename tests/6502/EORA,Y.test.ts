...
const tests = [
    ["flips_bits_over_setting_z_flag", { PC: 0x0000, A: 0xFF, Y: 0x03, value: 0xFF, flags: NO_FLAGS }, { PC: 0x0003, A: 0x00, Y: 0x03, value: 0xFF, flags: I | Z /* FIXME: should be Z */ }],
    ["flips_bits_over_setting_n_flag", { PC: 0x0000, A: 0x00, Y: 0x03, value: 0xFF, flags: NO_FLAGS }, { PC: 0x0003, A: 0xFF, Y: 0x03, value: 0xFF, flags: N | I /* FIXME: should be N */ }],
]

describe("EOR Absolute, Y-Indexed", () => {
