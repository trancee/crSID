...
const tests = [
    ["loads_a_sets_n_flag", { PC: 0x0000, X: 0x00, Y: 0x03, value: 0x80, flags: NO_FLAGS }, { PC: 0x0003, X: 0x80, Y: 0x03, value: 0x80, flags: N | I }],
    ["loads_a_sets_z_flag", { PC: 0x0000, X: 0xFF, Y: 0x03, value: 0x00, flags: NO_FLAGS }, { PC: 0x0003, X: 0x00, Y: 0x03, value: 0x00, flags: I | Z }],
]

describe("LDX Absolute, Y-Indexed", () => {
