...
const tests = [
    ["increments_memory", { PC: 0x0000, value: 0x09, flags: NO_FLAGS }, { PC: 0x0002, value: 0x0A, flags: I }],
    ["increments_memory_rolls_over_and_sets_zero_flag", { PC: 0x0000, value: 0xFF, flags: NO_FLAGS }, { PC: 0x0002, value: 0x00, flags: I | Z }],
    ["sets_negative_flag_when_incrementing_above_7F", { PC: 0x0000, value: 0x7F, flags: NO_FLAGS }, { PC: 0x0002, value: 0x80, flags: N | I }],
]
