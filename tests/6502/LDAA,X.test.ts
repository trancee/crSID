...
const tests = [
    ["loads_a_sets_n_flag", { PC: 0x0000, A: 0x00, X: 0x03, value: 0x80, flags: NO_FLAGS }, { PC: 0x0003, A: 0x80, X: 0x03, value: 0x80, flags: N | I }],
    ["loads_a_sets_z_flag", { PC: 0x0000, A: 0xFF, X: 0x03, value: 0x00, flags: NO_FLAGS }, { PC: 0x0003, A: 0x00, X: 0x03, value: 0x00, flags: I | Z }],
]

describe("LDA Absolute, X-Indexed", () => {
    ...
    test.each([
        ["does_not_page_wrap", { PC: 0x0000, A: 0x00, X: 0xFF, value: 0x42, flags: NO_FLAGS }, { PC: 0x0003, A: 0x42, X: 0xFF, value: 0x42, flags: I }],
        ...
        CPU.wr(0x0080 + cpu.X, input.value)
        ...
        expect(CPU.rd(0x0080 + cpu.X)[0]).toEqual(output.value)
