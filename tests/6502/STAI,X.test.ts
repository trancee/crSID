...
const tests = [
    ["stores_a_leaves_a_and_n_flag_unchanged", { PC: 0x0000, A: 0xFF, X: 0x03, value: 0x00, flags: ~N }, { PC: 0x0002, A: 0xFF, X: 0x03, value: 0xFF, flags: I }],
    ["stores_a_leaves_a_and_z_flag_unchanged", { PC: 0x0000, A: 0x00, X: 0x03, value: 0xFF, flags: ~Z }, { PC: 0x0002, A: 0x00, X: 0x03, value: 0x00, flags: I }],
]

describe("STA Indirect, Indexed (X)", () => {
