...
const tests = [
    ["loads_x_sets_n_flag", { PC: 0x0000, X: 0x00, value: 0x80, flags: NO_FLAGS }, { PC: 0x0002, X: 0x80, value: 0x80, flags: N | I }],
    ["loads_x_sets_z_flag", { PC: 0x0000, X: 0xFF, value: 0x00, flags: NO_FLAGS }, { PC: 0x0002, X: 0x00, value: 0x00, flags: I | Z }],
]

describe("LDX Zero Page", () => {
