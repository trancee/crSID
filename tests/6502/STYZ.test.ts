...
const tests = [
    ["stores_x_leaves_x_and_n_flag_unchanged", { PC: 0x0000, Y: 0xFF, value: 0x00, flags: ~N }, { PC: 0x0002, Y: 0xFF, value: 0xFF, flags: I }],
    ["stores_a_leaves_a_and_z_flag_unchanged", { PC: 0x0000, Y: 0x00, value: 0xFF, flags: ~Z }, { PC: 0x0002, Y: 0x00, value: 0x00, flags: I }],
]

describe("STY Zero Page", () => {
