...
const tests = [
    ["test_irq_pushes_pc_and_correct_status_then_sets_pc_to_irq_vector", { PC: 0xC123, flags: U }, { PC: 0xABCD, SP: 0xFC, PCH: 0xC1, PCL: 0x25 /* FIXME: should be 0x23 */, Status: U | B | I /* FIXME: should be U */, flags: U | I }],
]
