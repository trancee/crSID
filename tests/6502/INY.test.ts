...
const tests = [
    ["increments_y", { PC: 0x0000, Y: 0x09, flags: NO_FLAGS }, { PC: 0x0001, Y: 0x0A, flags: I }],
    ["above_FF_rolls_over_and_sets_zero_flag", { PC: 0x0000, Y: 0xFF, flags: NO_FLAGS }, { PC: 0x0001, Y: 0x00, flags: I | Z }],
    ["sets_negative_flag_when_incrementing_above_7F", { PC: 0x0000, Y: 0x7F, flags: NO_FLAGS }, { PC: 0x0001, Y: 0x80, flags: N | I }],
]
