...
const tests = [
    ["loads_a_sets_n_flag", { PC: 0x0000, X: 0x03, Y: 0x00, value: 0x80, flags: NO_FLAGS }, { PC: 0x0003, X: 0x03, Y: 0x80, value: 0x80, flags: N | I }],
    ["loads_a_sets_z_flag", { PC: 0x0000, X: 0x03, Y: 0xFF, value: 0x00, flags: NO_FLAGS }, { PC: 0x0003, X: 0x03, Y: 0x00, value: 0x00, flags: I | Z }],
]

describe("LDY Absolute, X-Indexed", () => {
