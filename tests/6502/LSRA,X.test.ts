...
const tests = [
    ["rotates_in_zero_not_carry", { PC: 0x0000, X: 0x03, value: 0x00, flags: C }, { PC: 0x0003, X: 0x03, value: 0x00, flags: I | Z }],
    ["sets_c_and_z_flags_after_rotation", { PC: 0x0000, X: 0x03, value: 0x01, flags: ~C }, { PC: 0x0003, X: 0x03, value: 0x00, flags: I | Z | C }],
    ["rotates_bits_right", { PC: 0x0000, X: 0x03, value: 0x04, flags: ~C }, { PC: 0x0003, X: 0x03, value: 0x02, flags: I }],
]

describe("LSR Absolute, X-Indexed", () => {
