...
const tests = [
    ["loads_a_sets_n_flag", { PC: 0x0000, A: 0x00, X: 0x03, value: 0x80, flags: NO_FLAGS }, { PC: 0x0002, A: 0x80, X: 0x03, value: 0x80, flags: N | I }],
    ["loads_a_sets_z_flag", { PC: 0x0000, A: 0x00, X: 0x03, value: 0x00, flags: NO_FLAGS }, { PC: 0x0002, A: 0x00, X: 0x03, value: 0x00, flags: I | Z }],
]

describe("LDA Indirect, Indexed (X)", () => {
